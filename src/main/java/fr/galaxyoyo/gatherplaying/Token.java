...
public enum Token
{
	...
	FAERIE_SPY(CREATURE_TOKEN, "UST", "4", "Flying, haste\nWhenever this creature deals combat damage to a player, draw a card.", "À chaque fois que cette créature inflige des " +
			"blessures de combat à un joueur, piochez une carte.", 1, 1, ManaColor.BLUE, new SubType[] {SubType.valueOf("Faerie"), SubType.valueOf("Spy")}, 439570),
	STORM_CROW(CREATURE_TOKEN, "UST", "5", "Flying", "Vol", 1, 2, ManaColor.BLUE, SubType.valueOf("Bird"), 439420),
	THOPTER_9(CREATURE_ARTIFACT_TOKEN, "UST", "6", "Flying", "Vol", 1, 1, ManaColor.BLUE, SubType.valueOf("Thopter")),
	ROGUE(CREATURE_TOKEN, "UST", "7", "Menace", "Menace", 2, 2, ManaColor.BLACK, SubType.valueOf("Rogue"), 439565, 439438),
	...
	BRAINIAC(CREATURE_TOKEN, "UST", "10", 1, 1, ManaColor.RED, SubType.valueOf("Brainiac"), 439465),
	ELEMENTAL_26(CREATURE_TOKEN, "UST", "11", 1, 1, ManaColor.RED, SubType.valueOf("Elemental")),
	GOBLIN_21(CREATURE_TOKEN, "UST", "12", 1, 1, ManaColor.RED, SubType.valueOf("Goblin"), 439466, 439471, 439572),
	...
	SQUIRREL_4(CREATURE_TOKEN, "UST", "15", 1, 1, ManaColor.GREEN, SubType.valueOf("Squirrel"), 439493, 439497, 439512),
	...
	CONSTRUCT_6(CREATURE_TOKEN, "UST", "19", 0, 0, ManaColor.COLORLESS, SubType.valueOf("Construct"), 439589),
	GNOME(CREATURE_TOKEN, "UST", "20", 1, 1, ManaColor.COLORLESS, SubType.valueOf("Gnome"), 439393, 439537, 439573, 439438),
	...
	BEAST_23(CREATURE_TOKEN, "IMA", "7", 4, 4, ManaColor.GREEN, SubType.valueOf("Beast"), 438734, 438750),

	// Ixalan (XLN)
	VAMPIRE_6(CREATURE_TOKEN, "XLN", "1", "Lifelink", "Lien de vie", 1, 1, ManaColor.WHITE, SubType.valueOf("Vampire"), 435173, 435174, 435176, 435177, 435181, 435375),
	ILLUSION_3(CREATURE_TOKEN, "XLN", "2", "When this creature becomes the target of a spell, sacrifice it.", "Quand cette créature devient la cible d'un sort, sacrifiez-la.",
			2, 2, ManaColor.BLUE, SubType.valueOf("Illusion"), 435212),
	MERFOLK_2(CREATURE_TOKEN, "XLN", "3", "Hexproof", "Défense talismanique", 1, 1, ManaColor.BLUE, SubType.valueOf("Merfolk"), 435203),
	PIRATE(CREATURE_TOKEN, "XLN", "4", "Menace", "Menace", 2, 2, ManaColor.BLACK, 435260, 435388),
	DINOSAUR(CREATURE_TOKEN, "XLN", "5", "Trample", "Piétinement", 3, 3, ManaColor.GREEN, SubType.valueOf("Dinosaur"), 435309, 435366, 435380, 435383),
	PLANT_4(CREATURE_TOKEN, "XLN", "6", "Defender", "Défenseur", 0, 2, ManaColor.GREEN, SubType.valueOf("Plant"), 435392),
	TREASURE_1(ARTIFACT_TOKEN, "XLN", "7", "{T}, Sacrifice this artifact: Add one mana of any color to your mana pool.", "{T}, sacrifiez cet artefact : Ajoutez un mana de la couleur " +
			"de votre choix à votre réserve.", SubType.valueOf("Treasure"), 435220, 435221, 435225, 435235, 435249, 435256, 435263, 435271, 435273, 435285, 435290, 435325, 435329,
			435376, 435388, 435403, 435410),
	...
	// Commander 2017 (C17)
	CAT_6(CREATURE_TOKEN, "C17", "1", 2, 2, ManaColor.WHITE, SubType.valueOf("Cat"), 432995, 433010),
	BAT_2(CREATURE_TOKEN, "C17", "2", "Flying", "Vol", 1, 1, ManaColor.BLACK, SubType.valueOf("Bat"), 433058),
	RAT_3(CREATURE_TOKEN, "C17", "3", "Deathtouch", "Contact mortel", 1, 1, ManaColor.BLACK, SubType.valueOf("Rat"), 433272),
	VAMPIRE_5(CREATURE_TOKEN, "C17", "4", 1, 1, ManaColor.BLACK, SubType.valueOf("Vampire"), 433277),
	ZOMBIE_37(CREATURE_TOKEN, "C17", "5", 2, 2, ManaColor.BLACK, SubType.valueOf("Zombie"), 433257),
	DRAGON_17(CREATURE_TOKEN, "C17", "6", "Flying", "Vol", 4, 4, ManaColor.RED, SubType.valueOf("Dragon"), 433097),
	DRAGON_18(CREATURE_TOKEN, "C17", "7", "Flying", "Vol", 4, 4, ManaColor.RED, SubType.valueOf("Dragon"), 433076),
	CAT_WARRIOR(CREATURE_TOKEN, "C17", "8", "Forestwalk", "Traversée des forêts", 2, 2, ManaColor.GREEN, new SubType[] {SubType.valueOf("Cat"), SubType.valueOf("Warrior")}, 433085),
	CAT_DRAGON(CREATURE_TOKEN, "C17", "9", "Flying", "Vol", 3, 3, new ManaColor[] {ManaColor.WHITE, ManaColor.BLUE, ManaColor.BLACK, ManaColor.RED, ManaColor.GREEN},
			new SubType[] {SubType.valueOf("Cat"), SubType.valueOf("Dragon")}, 433290),
	GOLD_3(ARTIFACT_TOKEN, "C17", "10", "Sacrifice this artifact: Add one mana of any color to your mana pool.",
			"Sacrifiez cet artefact : Ajoutez un mana de la couleur de votre choix à votre réserve.", 433265),
	ELDRAZI_SPAWN_7(CREATURE_TOKEN, "C17", "11", "Sacrifice this creature: Add {C} to your mana pool.", "Sacrifiez cette créature : Ajoutez {C} à votre réserve.", 0, 1,
			ManaColor.COLORLESS, new SubType[] {SubType.valueOf("Eldrazi"), SubType.valueOf("Spawn")}, 433052),
	...
	RESILIENT_KHENRA(CREATURE_TOKEN, "HOU", "6", "When Resilient Khenra enters the battlefield, you may have target creature get +X/+X until end of turn, where X is Resilient " +
			...
			"force du Khenra résistant.", 4, 4, ManaColor.BLACK, new SubType[] {SubType.valueOf("Zombie"), SubType.valueOf("Jackal"), SubType.valueOf("Wizard")}, 430820),
	SINUOUS_STRIKER(CREATURE_TOKEN, "HOU", "7", "{U}: Sinuous Striker get +1/+1 until end of turn.", "{U}: La Frappeuse sinueuse gagne +1/-1 jusqu'à la fin du tour.", 4, 4,
			ManaColor.BLACK, new SubType[] {SubType.valueOf("Zombie"), SubType.valueOf("Naga"), SubType.valueOf("Warrior")}, 430734),
	...
	SUNSCOURGE_CHAMPION(CREATURE_TOKEN, "HOU", "9", "When Sunscourge Champion enters the battlefield, you gain life equal to its power.", "Quand la Championne au fléau solaire arrive" +
			...
			("Human"), SubType.valueOf("Wizard")}, 430715),
	HORSE(CREATURE_TOKEN, "HOU", "10", 5, 5, ManaColor.WHITE, SubType.valueOf("Horse"), 430695),
	...
	BIRD_14(CREATURE_TOKEN, "MM3", "4", "Flying", "Vol", 1, 1, ManaColor.WHITE, SubType.valueOf("Bird"), 425830),
	SOLDIER_25(CREATURE_TOKEN, "MM3", "3", 1, 1, ManaColor.WHITE, SubType.valueOf("Soldier"), 425826),
	SPIRIT_23(CREATURE_TOKEN, "MM3", "4", "Flying", "Vol", 1, 1, ManaColor.WHITE, SubType.valueOf("Spirit"), 425837),
	SPIDER_7(CREATURE_TOKEN, "MM3", "5", "Reach", "Portée", 2, 4, ManaColor.BLACK, SubType.valueOf("Spider"), 425956),
	ZOMBIE_35(CREATURE_TOKEN, "MM3", "6", 2, 2, ManaColor.BLACK, SubType.valueOf("Zombie"), 425899),
	DRAGON_16(CREATURE_TOKEN, "MM3", "7", "Flying", "Vol", 4, 4, ManaColor.RED, SubType.valueOf("Dragon"), 433097),
	GOBLIN_20(CREATURE_TOKEN, "MM3", "8", 1, 1, ManaColor.RED, SubType.valueOf("Goblin"), 425918, 425920, 425997),
	BEAST_20(CREATURE_TOKEN, "MM3", "9", 3, 3, ManaColor.GREEN, SubType.valueOf("Beast"), 430614),
	BEAST_21(CREATURE_TOKEN, "MM3", "10", 4, 4, ManaColor.GREEN, SubType.valueOf("Beast"), 425945),
	...
	GIANT_WARRIOR_4(CREATURE_TOKEN, "MM3", "17", "Haste", "Célérité", 4, 4, new ManaColor[] {ManaColor.RED, ManaColor.GREEN}, new SubType[] {SubType.valueOf("Giant"),
			SubType.valueOf("Warrior")}, 426033),
	GOBLIN_WARRIOR_2(CREATURE_TOKEN, "MM3", "18", 1, 1, new ManaColor[] {ManaColor.RED, ManaColor.GREEN}, new SubType[] {SubType.valueOf("Goblin"), SubType.valueOf("Warrior")}, 426039),
	SOLDIER_26(CREATURE_TOKEN, "MM3", "19", 1, 1, new ManaColor[] {ManaColor.RED, ManaColor.WHITE}, SubType.valueOf("Soldier"), 426016),
	GOLEM_6(CREATURE_ARTIFACT_TOKEN, "MM3", "20", 3, 3, ManaColor.COLORLESS, SubType.valueOf("Golem"), 425828, 425840, 425848, 425882, 425970),
	DOMRI_RADE_2(EMBLEM, "MM3", "21", "Creatures you control have double strike, trample, hexproof and haste.", "Les créatures que vous contrôlez ont la double initiative, le " +
			"piétinement, la défense talismanique et la célérité.",	SubType.valueOf("Domri"), 425986),

	// La révole éthérique (AER)
	GREMLIN(CREATURE_TOKEN, "AER", "1", 2, 2, ManaColor.RED, SubType.valueOf("Gremlin"), 423750, 423763),
	RAGAVAN(CREATURE_TOKEN, "AER", "2", 2, 1, ManaColor.RED, true, SubType.valueOf("Monkey"), 423754),
	ETHERIUM_CELL(ARTIFACT_TOKEN, "AER", "3", "{T}, Sacrifice this artifact: Add one mana of any color to your mana pool.", "{T}, sacrifiez cet artefact : ajoutez un mana de la " +
			"couleur de votre choix à voitre réserve.", 423804),
	TEZZERET_THE_SCHEMER(EMBLEM, "AER", "4", "At the beginning of combat on your turn, target artifact you control becomes an artifact creature with base power and toughness 5/5.",
			...
			.valueOf("Tezzeret"), 423804),

	// Commander 2016 (C16)
	SPIRIT_21(CREATURE_TOKEN, "C16", "1", "Flying", "Vol", 1, 1, ManaColor.COLORLESS, SubType.valueOf("Spirit"), 420913),
	BIRD_12(CREATURE_TOKEN, "C16", "2", "Flying", "Vol", 1, 1, ManaColor.WHITE, SubType.valueOf("Bird"), 420655),
	ELEMENTAL_24(CREATURE_TOKEN, "C16", "3", "Flying", "Vol", 4, 4, ManaColor.WHITE, SubType.valueOf("Elemental"), 420684),
	GOAT_5(CREATURE_TOKEN, "C16", "4", 0, 1, ManaColor.WHITE, SubType.valueOf("Goat"), 420895),
	SOLDIER_24(CREATURE_TOKEN, "C16", "5", 1, 1, ManaColor.WHITE, SubType.valueOf("Soldier"), 420858, 420619),
	SPIRIT_22(CREATURE_TOKEN, "C16", "6", "Flying", "Vol", 1, 1, ManaColor.WHITE, SubType.valueOf("Spirit"), 420680),
	BIRD_13(CREATURE_TOKEN, "C16", "7", "Flying", "Vol", 2, 2, ManaColor.BLUE, SubType.valueOf("Bird"), 420715),
	SQUID_3(CREATURE_TOKEN, "C16", "8", "Islandwalk", "Traversée des îles", 1, 1, ManaColor.BLUE, SubType.valueOf("Squid"), 420702),
	THOPTER_8(CREATURE_ARTIFACT_TOKEN, "C16", "9", "Flying", "Vol", 1, 1, ManaColor.BLUE, SubType.valueOf("Thopter"), 420646, 420854),
	GERM_5(CREATURE_TOKEN, "C16", "10", 0, 0, ManaColor.BLACK, SubType.valueOf("Germ"), 420862, 420626),
	ZOMBIE_34(CREATURE_TOKEN, "C16", "11", 2, 2, ManaColor.BLACK, SubType.valueOf("Zombie"), 420722, 420734),
	GOBLIN_19(CREATURE_TOKEN, "C16", "12", "Creatures you control attack each combat if able.", "Les créatures que vous contrôlez attaquent à chaque combat si possible.", 1, 1,
			ManaColor.RED, SubType.valueOf("Goblin"), 420636),
	OGRE_3(CREATURE_TOKEN, "C16", "13", 3, 3, ManaColor.RED, SubType.valueOf("Ogre"), 420747),
	BEAST_19(CREATURE_TOKEN, "C16", "14", 3, 3, ManaColor.GREEN, SubType.valueOf("Beast"), 420758),
	ELF_WARRIOR_7(CREATURE_TOKEN, "C16", "15", 1, 1, ManaColor.GREEN, new SubType[] {SubType.valueOf("Elf"), SubType.valueOf("Warrior")}, 420830),
	SAPROLING_11(CREATURE_TOKEN, "C16", "16", 1, 1, ManaColor.GREEN, SubType.valueOf("Saproling"), 420796, 420797, 420817, 420825, 420775, 420832, 421905, 420662, 420788),
	SAPROLING_12(CREATURE_TOKEN, "C16", "17", 1, 1, ManaColor.GREEN, SubType.valueOf("Saproling"), 420796, 420797, 420817, 420825, 420775, 420832, 421905, 420662, 420788),
	WORM_4(CREATURE_TOKEN, "C16", "18", 1, 1, new ManaColor[] {ManaColor.BLACK, ManaColor.GREEN}, SubType.valueOf("Worm"), 420855),
	HORROR_4(CREATURE_ARTIFACT_TOKEN, "C16", "19", 0, 0, ManaColor.COLORLESS, SubType.valueOf("Horror"), 420690),
	MYR_6(CREATURE_ARTIFACT_TOKEN, "C16", "20", 1, 1, ManaColor.COLORLESS, SubType.valueOf("Myr"), 420880),
	DARETTI_2(EMBLEM, "C16", "21", "Whenever an artifact is put into your graveyard from the battlefield, return that card to the battlefield at the beginning of the next end " +
			...
			"étape de fin.", SubType.valueOf("Daretti"), 420740),
